...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    echo json_encode(create_date($result), JSON_UNESCAPED_UNICODE);
    return;
}
...
<div id="app" class="main">
    ...
    <table contenteditable="true">
        ...
        <tr>
            <td id="date_event"><?php echo $db_response[0]["date_event"]?></td>
            <td id="event_ids"><?php echo $db_response[0]["event_ids"]?></td>
    ...
    <button id="change__date" style="cursor: pointer;">Обновить</button>
