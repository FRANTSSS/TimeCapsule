...
function get_table($db_response){
    ...
    foreach($db_response as $tr_values){
        $table_entry = '<tr>';
        $table_entry .= '<td><a href="tag.php?id=' . $tr_values['id'] . '">Редактировать</a>';
...
<head>
    <meta charset="UTF-8">
    <title>Almanac Events | Теги</title>
...
<div id="app" class="main">
    ...
    <div id="tittle_groups_page">
        Теги
        <button id="add_group" onclick="document.location='./tag_add.php'" style="cursor: pointer;">+</button>
    </div>
    <table>
        <?php echo $group_table ?>
    </table>
    <script type="module">
        import {add_handlers_buttons} from "./public/script/tag_crud_handler.js";
