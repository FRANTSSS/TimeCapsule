...
function get_group(){
    $query = "SELECT id, name FROM \"theme\" WHERE id='" . strval($_GET["id"]) . "';";
...
<head>
    <meta charset="UTF-8">
    <title>Almanac Events | Темы | Создать</title>
...
<div id="app" class="main">
    ...
    <table contenteditable="true">
        ...
        <tr>
            <td>Название новой темы</td>
        </tr>
        </tbody>
    </table>
    <button id="create_group" style="cursor: pointer;">Создать</button>
    <script type="module">
        import {add_handler_create_button} from "./public/script/theme_crud_handler.js";
